...
public interface ProductRepository extends JpaRepository<Product, Integer> {
	...
	@Query("SELECT p FROM Product p JOIN FETCH p.color JOIN FETCH p.brand JOIN FETCH p.seller WHERE p.sellerId = :sellerId")
	List<Product> findBySellerId(@Param(value = "sellerId") Integer sellerId);
}
